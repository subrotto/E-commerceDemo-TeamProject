...
if(isset($_POST['order_btn'])){
   ...
   $address = mysqli_real_escape_string($conn, 'street. '. $_POST['street'].', '. $_POST['city'].', '. $_POST['division']);
...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="name of your city ">
         </div>
         <div class="inputBox">
            <span>division :</span>
            <input type="text" name="division" required placeholder="name of your division">
         </div>
        
         <div class="inputBox">
            <span>zip :</span>
            <input type="number" min="0" name="pin_code" required placeholder="enter your zip code">
         </div>
      </div>
